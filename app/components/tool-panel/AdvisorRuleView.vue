...
<template>
    <div
        class="bg-gray-100 dark:bg-slate-800 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow duration-300"
    >
        <div class="flex flex-col space-y-3">
            ...
            <div class="flex items-center">
                <UIcon
                    ...
                    class="text-amber-500 mr-2 flex-shrink-0"
                />
            ...
            <div
                v-if="props.rule.example"
                class="flex items-start space-x-2 bg-gray-200 dark:bg-slate-700 p-2 rounded"
            >
                <UIcon
                    name="i-lucide-eyedropper"
                    class="text-purple-500 mt-1 flex-shrink-0"
                />
            ...
            <div
                class="flex items-start space-x-2 bg-green-100 dark:bg-green-900/20 p-2 rounded"
            >
                <UIcon
                    name="i-lucide-check-check"
                    class="text-green-600 dark:text-green-400 mt-1 flex-shrink-0"
                />
                <div>
                    <p
                        class="text-xs font-semibold text-gray-600 dark:text-gray-300"
                    >
                        {{ t('advisor.proposal') || 'Proposal' }}:
                    </p>
