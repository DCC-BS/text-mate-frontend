  ...
  <div class="flex justify-between">
    <div>
      <UTooltip :text="t('navigation.undo')" :kbds="['Ctrl', 'Z']">
        <UButton icon="i-lucide-undo" variant="link" color="neutral" @click="handleUndo" :disabled="!undoRedoState.canUndo"></UButton>
      </UTooltip>
      <UTooltip :text="t('navigation.redo')" :kbds="['Ctrl', 'Y']">
        <UButton icon="i-lucide-redo" variant="link" color="neutral" @click="handleRedo" :disabled="!undoRedoState.canRedo"></UButton>
      </UTooltip>
    </div>
